...
def generate_dummy_document(collection_name, column_names, n):
    ...
    for _ in range(n):
        ...
        if "transaction" in collection_name.lower():
            ...
            transaction_date = datetime(2023, 7, 17, 7, 11, 52).strftime("%Y-%m-%d %H:%M:%S")
            document["transaction_date"] = 'new Date("' + transaction_date + '")'
            total_amount = round(random.uniform(10, 1000), 2)
            document["total_amount"] = f'NumberDecimal("{total_amount}")'
